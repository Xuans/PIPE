define([].concat(window.aweb.transformJsConfig([ "jquery", "slimScroll", "component.leftCatalog", "component.topNav", "ctn", "ctn.divCtn" ])).concat(window.aweb.transformCssConfig([ "leftCatalog/leftCatalogBootstrap.css", "leftCatalog/leftCatalog.css", "topNav/topNav.css", "AUI/css/layout.ctn.css", "css/indexPage-indexPage_1AB7285AC15CFD828325-6129.css" ])), function() {
    return function() {
        return function() {
                ...
                auiCtx = {
                    ...
                    configs: {
                        ...
                        banner: {
                            ...
                            logo: {
                                src: "./img/6F48CF457F228EDEAED8-8F84.png",
                                alt: "赞同科技",
                                title: ""
                            },
                            message_area: {
                    ...
                    lifecycle: {
                        leftCatalog_load_init_000002: {
                            func: function(response) {
                                ...
                                auiCtx.variables.leftCatalog.refresh(data);
                            },
                            callback: function(e) {
                                aweb.debug && aweb.stepTo("indexPage-indexPage-生命周期配置-侧边菜单设置数据");
                                $.ajax(auiCtx.ajaxOption.leftCatalog_load_init_000002);
                            },
                            times: 0,
                            clock: 1e3,
                            immediate: false,
 ...
 */
                        ...
                        leftCatalog_load_init_000005: {
                            func: function() {
                                aweb.debug && aweb.stepTo("indexPage-indexPage-生命周期配置-设置侧边菜单假数据");
                    ...
                    ajaxOption: {
                        leftCatalog_load_init_000002: {
                            type: "POST",
                            url: "##_springmvc/menu/loadMenu.do",
                            urlDivider: "/",
                            timeout: 6e4,
                            noAgreeBusData: true,
                            ...
                            success: function(response) {
                                if (response.status) {
                                    if (response.type && response.type !== "AJAX") {
                                        ...
                                        auiCtx.lifecycle.leftCatalog_load_init_000002.func(response);
                                    }
 ...
 */
                    ...
                    auiCtxLoad: function(auiCtx, _$el, _scope, _handler) {
                        ...
                        auiCtx.lifecycle.leftCatalog_load_init_000002.callback();
                        auiCtx.lifecycle.awebMainContainer_load_init_000004.func();
                        auiCtx.lifecycle.leftCatalog_load_init_000005.func();
                    },
