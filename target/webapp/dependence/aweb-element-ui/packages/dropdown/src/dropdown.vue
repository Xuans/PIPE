<script>
  ...
  import Migrating from 'aweb-element-ui/src/mixins/migrating';
  import ElButton from 'aweb-element-ui/packages/button';
  import ElButtonGroup from 'aweb-element-ui/packages/button-group';
  import { generateId } from 'aweb-element-ui/src/utils/util';
