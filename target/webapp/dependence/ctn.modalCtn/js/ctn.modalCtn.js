...
( /* <global> */function (undefined) {
    ...
    (function ($, widget) {
        ...
        widget.off([widget.STATUS.WIDGET_INIT, widget.STATUS.WIDGET_UPDATE].join('.ctn.modalCtn,') + '.ctn.modalCtn')
             .on([widget.STATUS.WIDGET_INIT, widget.STATUS.WIDGET_UPDATE].join('.ctn.modalCtn,') + '.ctn.modalCtn', function (type, oWidget) {
