    ...
    (function ($, widget, Handsontable/*,其他脚本文件对外暴露接口请在这里填写，如'charts'*/) {
        ...
        Component.prototype = Component.fn = {
            ...
            removeCol: function (colInfo) {
                ...
                if(colname.length-1>=colInfo){
                    if(this.config.hiddenColumns.hasOwnProperty(colname[colInfo])){
                        this.config.hiddenColNums -=1;
                    }else{
                        this.nullWidthCount--;
                    }
            ...
            addRow:function(rowInfo){
                ...
                tableData = app.deepClone(this.data);
                if (rowInfo.data) {
                    ...
                    tableData.splice(index,0, this.dataArrToMap([rowInfo.data])[0]);
