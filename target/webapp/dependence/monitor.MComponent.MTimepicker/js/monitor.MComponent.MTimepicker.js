    ...
    (function ($, widget) {
        ...
        function renderRunnerInlineLabelSpan($selector, template, labelSpan, labelAlign, auiCtx, dataWidgetType) {
            var $form = $selector.closest("[data-widget-type=aweb4FoundationFormCtn]"),
                ...
                pwdOption = auiCtx.configs[$ele.attr("id")],
        ...
        function initTimePicker() {
            ...
            var extendRemove = function (target, props) {
                ...
                for (var name in props) {
                    if (props.hasOwnProperty(name) && (props[name] === null || props[name] === undefined)) {
        ...
        function render(widgetIns, $widget, option, css,formOption) {

            var $input,
                horizontalTemp = "<label>_label_</label>_CONTENT_",
                ...
                classname,
                switchr,
                isInline = formOption && formOption.formLayout === 'inline',
            ...
            template = template
                .replace(/_label_/, option.label || "")
                .replace(/_CONTENT_/, $widget.find('input')[0].outerHTML);


            if (isInline) {

                $widget = renderRunnerInlineLabelSpan($widget,
                    template,
                    labelSpan,
                    labelAlign,
                    auiCtx,
                ...
                attr.id && $widget.attr('id', attr.id);
            } else {

                $widget.html(template);
                renderContainerSpan($widget, span);
            ...
            return {
                ...
                getDateString: function () {
                    ...
                    if (ret = $input.val()) {
                        ...
                        ret = (new Date($input.val())).valueOf();
                    }
        ...
        widget.monitor.MComponent.MTimepicker = function () {
            var formWidget, formOption,
                returnValue,
                $widget = arguments[0],
                option = arguments[1],
                attr = arguments[2],
            ...
            //运行时代码Start
            return render(null, $widget, option, css,formOption);
            //运行时代码End
